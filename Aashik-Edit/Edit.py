...
buttons = [
    ...
    [
        InlineKeyboardButton(text="𝗦𝘂𝗽𝗽𝗼𝗿𝘁", url=f"https://t.me/wanna_lovely"),
        InlineKeyboardButton(text="𝗦𝗼𝘂𝗿𝗰𝗲", url=f"https://t.me/wanna_lovely"),
    ],    
    [
        InlineKeyboardButton(text="𝗢𝘄𝗻𝗲𝗿", url=f"https://t.me/Uxrcqr"),
    ],
